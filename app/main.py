...
from app.routers.inventory import router as inventory_router  # inventory router
...
app.include_router(floor_traffic_router, prefix="/api/floor-traffic", tags=["floor-traffic"])
