...
# CORS configuration: explicitly allow your front-end and API origins
allowed_origins = [
    os.getenv("FRONTEND_URL", "https://aiventa-crm.vercel.app"),
    os.getenv("RENDER_EXTERNAL_URL", "https://aiventa-crm.onrender.com"),
]
app.add_middleware(
    CORSMiddleware,
...
# Serve React app for all other GETs
app.mount(
    "/",
